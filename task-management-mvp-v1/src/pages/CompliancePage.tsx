    ...
    <div className="animate-slide-up">
      <div className="flex items-start gap-3 mb-5">
        <div className="flex-1">
          <h1 className="font-serif text-[22px] font-semibold text-gray-900">Compliance Master</h1>
          <p className="text-[13px] text-gray-500 mt-0.5">All statutory deadlines and filing schedules</p>
        </div>
      </div>
