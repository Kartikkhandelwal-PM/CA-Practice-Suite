...
import { Settings, Users, Bell, Link as LinkIcon, Shield, Plus, Edit2, Trash2, Check, X, Mail, Sliders } from 'lucide-react';
  ...
  return (
    <div className="h-full flex flex-col animate-slide-up">
      <div className="flex items-start justify-between mb-5 shrink-0">
        <div>
          <h1 className="font-serif text-[22px] font-semibold text-gray-900">Settings</h1>
          <p className="text-[13px] text-gray-500 mt-0.5">Manage your workspace, team, and integrations</p>
        </div>
      </div>
