...
import { Plus, Search, Folder, FolderOpen, FileText, Upload, Trash2, Download, Copy, X, Building2 } from 'lucide-react';
    ...
    <div className="h-full flex flex-col animate-slide-up">
      <div className="flex items-start gap-3 mb-5 shrink-0">
        <div className="flex-1">
          <h1 className="font-serif text-[22px] font-semibold text-gray-900">Document Manager</h1>
          <p className="text-[13px] text-gray-500 mt-0.5">{docs.length} documents across {folders.length} folders</p>
        </div>
