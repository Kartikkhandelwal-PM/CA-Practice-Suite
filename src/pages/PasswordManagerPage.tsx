...
import { Plus, Search, KeyRound, Edit2, Trash2, Users, Lock, Copy, Check, Eye, EyeOff, ShieldAlert, ExternalLink, Building2, ChevronRight, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="h-full flex flex-col animate-slide-up">
      <div className="flex items-start justify-between mb-5 shrink-0">
        <div>
          <h1 className="font-serif text-[22px] font-semibold text-gray-900">Password Manager</h1>
          <p className="text-[13px] text-gray-500 mt-0.5">Securely store client portal credentials</p>
        </div>
