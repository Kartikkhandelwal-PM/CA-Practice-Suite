    ...
    try {
      if (mode === 'signup') {
        ...
        if (phone === '9509264338' && pin === '1104') {
          ...
          throw new Error('Invalid Phone Number or PIN. For demo, use 9509264338 / 1104.');
        }
      }
    } catch (error: any) {
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <form onSubmit={handleAuth} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-[13px] font-semibold text-gray-700 mb-2">PIN</label>
                    <div className="relative">
